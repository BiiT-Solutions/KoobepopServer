...
@UIScope
@SpringComponent
public class KoobepopLogin extends LoginPresenter implements ILoginPresenter {
...
//				UsmoMessageManager.showError(LanguageCode.ERROR_BADUSERPSWD, LanguageCode.ERROR_TRYAGAIN);
//			} catch (UserManagementException | AuthenticationRequired e) {
//				UsmoLogger.errorMessage(this.getClass().getName(), e);
//				UsmoMessageManager.showError(LanguageCode.ERROR_USER_SERVICE, LanguageCode.ERROR_CONTACT);
//			} catch (InsufficientPermissions e) {
//				UsmoMessageManager.showError(LanguageCode.ERROR_INSUFFICIENT_PERMISSIONS, LanguageCode.ERROR_CONTACT);
//			}
		}
